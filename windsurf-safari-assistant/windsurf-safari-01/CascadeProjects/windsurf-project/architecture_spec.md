...
classDiagram
    ...
    note for StreamlitApp "Frontend Layer\nHandles UI and user interaction"
    note for FileManager "File Operations\nDirectory traversal and file handling"
    note for TextProcessor "Text Processing\nMarkdown parsing and cleaning"
    note for ConceptAnalyzer "Core Analysis\nConcept matching and counting"
    note for ResultsGenerator "Output Generation\nTables, charts, and exports"
```
